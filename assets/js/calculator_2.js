...
console.log(typeof data);
    ...
    function calculate_canada_prices(tax_rate){
        if(tax_rate){
            ...
            // add data attributes
            $('#total_monthly').attr('data-monthly-total', monthly_added_premium.toFixed(2));
            $('#total_monthly').attr('data-currency', 'CAD');


            $('#total_annual').html(flag + ' $' + currency_formatted(annual_added_premium));
            // add data attributes
            $('#total_annual').attr('data-annual-total', annual_added_premium.toFixed(2));
            $('#total_annual').attr('data-currency', 'CAD');
    ...
    function calculate_usa_prices(tax_rate){
        ...
        if(tax_rate){
            ...
            // add data attributes
            $('#total_monthly').attr('data-monthly-total', mothly_added_tax);
            $('#total_monthly').attr('data-currency', 'USD');


            $('#total_annual').html(flag + ' $' + currency_formatted(annual_added_tax));
            // add data attributes
            $('#total_annual').attr('data-annual-total', annual_added_tax);
...
$('#order_monthly').on('click', function(e){
    ...
    $('#total').val($('#total_monthly').attr('data-monthly-total'));
    $('#total_employees').val($('#employees_num').val());
});

$('#order_annual').on('click', function(e){
    e.preventDefault();
    $('#monthly_modal').modal('show');
